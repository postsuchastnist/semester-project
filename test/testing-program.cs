...
{
    public class Matrix //creating a class Matrix which creates a matrix and does operations on the matrices
    {
        int rows, cols;
        double[,] a;
...
//if the command is add or mult, program will politely ask you to write 2 matrices, for other commands you only need 1 matrix
